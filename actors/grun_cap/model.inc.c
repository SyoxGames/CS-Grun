Lights1 grun_cap_Emblem__EMBLEM__lights = gdSPDefLights1(
	0x4E, 0x17, 0x0,
	0xA0, 0x38, 0x0, 0x28, 0x28, 0x28);

Lights1 grun_cap_Cap__CAP__lights = gdSPDefLights1(
	0x28, 0x5E, 0x0,
	0x58, 0xC0, 0x0, 0x28, 0x28, 0x28);

Lights1 grun_cap_Metal__METAL__lights = gdSPDefLights1(
	0x28, 0x5E, 0x0,
	0x58, 0xC0, 0x0, 0x28, 0x28, 0x28);

Gfx grun_cap_Metal_Shade_rgba16_rgba16_aligner[] = {gsSPEndDisplayList()};
u8 grun_cap_Metal_Shade_rgba16_rgba16[] = {
	#include "grun/Metal_Shade_rgba16.rgba16.inc.c"
};

Gfx grun_cap_Metal_Light_rgba16_rgba16_aligner[] = {gsSPEndDisplayList()};
u8 grun_cap_Metal_Light_rgba16_rgba16[] = {
	#include "grun/Metal_Light_rgba16.rgba16.inc.c"
};

Vtx grun_cap_Normal_Cap_DL_mesh_layer_1_vtx_0[18] = {
	{{{-57, 16, -24}, 0, {-16, 1008}, {0xE4, 0x93, 0xC6, 0xFF}}},
	{{{-68, 18, -13}, 0, {-16, 496}, {0xB7, 0x9A, 0xEE, 0xFF}}},
	{{{-61, 36, -23}, 0, {496, 496}, {0x9D, 0xE8, 0xB4, 0xFF}}},
	{{{-56, 17, -24}, 0, {-16, 1008}, {0x5C, 0xB1, 0x27, 0xFF}}},
	...
	{{{-55, 62, -43}, 0, {1008, 1008}, {0x75, 0x26, 0xE1, 0xFF}}},
...
Gfx grun_cap_Normal_Cap_DL_mesh_layer_1_tri_0[] = {
	gsSPVertex(grun_cap_Normal_Cap_DL_mesh_layer_1_vtx_0 + 0, 18, 0),
...
Vtx grun_cap_Normal_Cap_DL_mesh_layer_1_vtx_1[118] = {
	{{{66, 52, 56}, 0, {-16, 1008}, {0x00, 0x88, 0x2A, 0xFF}}},
	{{{0, 47, 71}, 0, {-16, 1008}, {0x00, 0x88, 0x2A, 0xFF}}},
	{{{-66, 52, 56}, 0, {-16, 1008}, {0x00, 0x88, 0x2A, 0xFF}}},
	{{{-62, 23, -17}, 0, {-16, 1008}, {0x00, 0x88, 0x2A, 0xFF}}},
	{{{-74, 44, 20}, 0, {-16, 1008}, {0x00, 0x88, 0x2A, 0xFF}}},
	{{{63, 23, -17}, 0, {-16, 1008}, {0x00, 0x88, 0x2A, 0xFF}}},
	{{{0, 14, -35}, 0, {-16, 1008}, {0x00, 0x88, 0x2A, 0xFF}}},
	{{{75, 44, 20}, 0, {-16, 1008}, {0x00, 0x88, 0x2A, 0xFF}}},
	{{{2, 71, -32}, 0, {57, -16}, {0x10, 0xA6, 0x58, 0xFF}}},
	{{{1, 58, -39}, 0, {57, -16}, {0x06, 0x97, 0x47, 0xFF}}},
	{{{0, 43, -74}, 0, {54, -16}, {0xFF, 0x98, 0xB8, 0xFF}}},
	...
	{{{63, 23, -17}, 0, {-16, -16}, {0xA2, 0x53, 0x10, 0xFF}}},
	...
	{{{0, 33, 74}, 0, {569, 803}, {0x00, 0x9F, 0xAE, 0xFF}}},
	...
	{{{75, 30, 23}, 0, {862, 803}, {0x9A, 0xB9, 0x1B, 0xFF}}},
	{{{63, 8, -14}, 0, {1008, 803}, {0xCE, 0xB9, 0x5C, 0xFF}}},
	{{{63, 23, -17}, 0, {1008, 1008}, {0xA2, 0x53, 0x10, 0xFF}}},
	...
	{{{76, 35, 69}, 0, {715, 598}, {0x30, 0x9C, 0x3E, 0xFF}}},
	{{{66, 37, 59}, 0, {715, 803}, {0xC3, 0x9C, 0xCF, 0xFF}}},
	...
	{{{-62, 23, -17}, 0, {130, -16}, {0x5E, 0x53, 0x10, 0xFF}}},
	{{{0, 16, -48}, 0, {57, 189}, {0x00, 0x67, 0xB5, 0xFF}}},
	{{{0, 14, -35}, 0, {57, -16}, {0x00, 0x57, 0x5D, 0xFF}}},
	{{{0, 3, -54}, 0, {57, 394}, {0x00, 0xE4, 0x84, 0xFF}}},
	...
	{{{-86, 24, 21}, 0, {277, 598}, {0xC1, 0x96, 0x20, 0xFF}}},
	{{{-62, 23, -17}, 0, {130, 1008}, {0x5E, 0x53, 0x10, 0xFF}}},
	{{{-75, 35, 69}, 0, {423, 598}, {0xD0, 0x9C, 0x3E, 0xFF}}},
	{{{-66, 37, 59}, 0, {423, 803}, {0x3D, 0x9C, 0xCF, 0xFF}}},
	{{{0, 31, 88}, 0, {569, 598}, {0x00, 0x95, 0x45, 0xFF}}},
	{{{0, 45, 95}, 0, {569, 394}, {0x00, 0x14, 0x7D, 0xFF}}},
...
Gfx grun_cap_Normal_Cap_DL_mesh_layer_1_tri_1[] = {
	gsSPVertex(grun_cap_Normal_Cap_DL_mesh_layer_1_vtx_1 + 0, 32, 0),
	...
	gsSPVertex(grun_cap_Normal_Cap_DL_mesh_layer_1_vtx_1 + 32, 32, 0),
	...
	gsSPVertex(grun_cap_Normal_Cap_DL_mesh_layer_1_vtx_1 + 64, 32, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 3, 1, 0),
	...
	gsSPVertex(grun_cap_Normal_Cap_DL_mesh_layer_1_vtx_1 + 96, 22, 0),
...
Gfx mat_grun_cap_Emblem__EMBLEM_[] = {
	gsDPPipeSync(),
...
Gfx mat_grun_cap_Metal__METAL_[] = {
	gsDPPipeSync(),
	gsDPSetCombineLERP(TEXEL0, 0, SHADE, TEXEL1, 0, 0, 0, ENVIRONMENT, TEXEL0, 0, SHADE, TEXEL1, 0, 0, 0, ENVIRONMENT),
	gsSPGeometryMode(0, G_TEXTURE_GEN),
	gsSPTexture(4032, 1984, 0, 0, 1),
	gsSPSetLights1(grun_cap_Metal__METAL__lights),
	gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b_LOAD_BLOCK, 1, grun_cap_Metal_Shade_rgba16_rgba16),
	gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b_LOAD_BLOCK, 0, 0, 7, 0, G_TX_WRAP | G_TX_NOMIRROR, 0, 0, G_TX_WRAP | G_TX_NOMIRROR, 0, 0),
	gsDPLoadBlock(7, 0, 0, 2047, 128),
	gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 16, 0, 0, 0, G_TX_WRAP | G_TX_NOMIRROR, 5, 0, G_TX_WRAP | G_TX_NOMIRROR, 6, 0),
	gsDPSetTileSize(0, 0, 0, 252, 124),
	gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b_LOAD_BLOCK, 1, grun_cap_Metal_Light_rgba16_rgba16),
...
Gfx mat_revert_grun_cap_Metal__METAL_[] = {
	gsDPPipeSync(),
	gsSPGeometryMode(G_TEXTURE_GEN, 0),
	gsSPEndDisplayList(),
};

Gfx grun_cap_Normal_Cap_DL_mesh_layer_1[] = {
	gsSPDisplayList(mat_grun_cap_Emblem__EMBLEM_),
	gsSPDisplayList(grun_cap_Normal_Cap_DL_mesh_layer_1_tri_0),
	gsSPDisplayList(mat_grun_cap_Cap__CAP_),
	gsSPDisplayList(grun_cap_Normal_Cap_DL_mesh_layer_1_tri_1),
	gsSPEndDisplayList(),
};

Gfx grun_cap_Normal_Cap_DL_mesh_layer_1_mat_override_Metal__METAL__0[] = {
	gsSPDisplayList(mat_grun_cap_Metal__METAL_),
	gsSPDisplayList(grun_cap_Normal_Cap_DL_mesh_layer_1_tri_0),
	gsSPDisplayList(grun_cap_Normal_Cap_DL_mesh_layer_1_tri_1),
	gsSPEndDisplayList(),
};

Gfx grun_cap_material_revert_render_settings[] = {
	gsDPPipeSync(),
